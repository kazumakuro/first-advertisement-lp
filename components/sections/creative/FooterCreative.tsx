...
export function FooterCreative() {
  ...
  return (
    <footer className="bg-gradient-to-b from-pink-50 to-violet-50 border-t border-purple-100">
      <div className="container mx-auto px-4 md:px-6 lg:px-8 py-12 md:py-16">
        ...
        <div className="border-t border-purple-100 pt-8 flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-2 text-purple-600 text-sm hover:text-purple-500 transition-colors"
          >
            <span>無料で相談する</span>
            <svg
              className="w-4 h-4"
