      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-12 md:mb-16">
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-gray-800">
            こんな<span className="text-primary-500">お悩み</span>ありませんか？
          </h2>
        </div>
        ...
        <div className="relative max-w-4xl mx-auto">
          ...
          <div className="hidden md:block">
            ...
            <div className="absolute left-0 top-8 w-[280px] transform -translate-x-4">
              <div className="bg-gray-600 text-white p-4 rounded-2xl rounded-br-none shadow-lg">
            ...
            <div className="absolute left-0 bottom-24 w-[280px] transform -translate-x-4">
              <div className="bg-gray-600 text-white p-4 rounded-2xl rounded-tr-none shadow-lg">
                <p className="text-sm font-medium leading-relaxed">
            ...
            <div className="absolute right-0 top-8 w-[280px] transform translate-x-4">
              <div className="bg-gray-600 text-white p-4 rounded-2xl rounded-bl-none shadow-lg">
                <p className="text-sm font-medium leading-relaxed">
            ...
            <div className="absolute right-0 bottom-24 w-[280px] transform translate-x-4">
              <div className="bg-gray-600 text-white p-4 rounded-2xl rounded-tl-none shadow-lg">
                <p className="text-sm font-medium leading-relaxed">
          ...
          <div className="md:hidden">
            ...
            <div className="space-y-4">
              {problems.items.map((problem, index) => (
                <div
                  key={index}
                  className="bg-gray-600 text-white p-4 rounded-2xl shadow-lg"
                >
