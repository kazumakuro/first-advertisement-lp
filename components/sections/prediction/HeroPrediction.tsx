      ...
      <div className="relative z-10 container mx-auto px-4 md:px-6 lg:px-8 pt-12 md:pt-20 pb-20">
        <div className="flex flex-col items-center gap-8">
          ...
          <div className="text-center max-w-3xl">
            {/* Badge */}
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-trust-500/10 border border-trust-500/30 mb-6">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center mb-8">
              <a
                ...
                rel="noopener noreferrer"
                onClick={handlePrimaryClick}
                className="inline-flex items-center justify-center px-8 py-4 bg-trust-500 text-white font-semibold text-lg uppercase tracking-wider shadow-lg shadow-trust-500/25 btn-magnetic"
              >
                {hero.cta.primary}
                <svg
            ...
            {/* フローティングバッジ */}
            <div className="inline-flex items-center gap-3 bg-dark-50 rounded-xl shadow-lg px-6 py-4 border border-trust-500/30">
