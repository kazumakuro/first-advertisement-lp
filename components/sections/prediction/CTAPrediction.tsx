...
import { cta } from "@/config/content-prediction";
...
export function CTAPrediction() {
  const handleCTAClick = () => {
    trackCTAClick("cta-prediction", cta.primary);
    trackExternalLink("LINE", "cta-prediction");
  };

  return (
    <Section background="industrial" id="cta">
      <div className="relative max-w-5xl mx-auto">
        {/* Background effect */}
        <div className="absolute inset-0 bg-gradient-to-r from-trust-500/10 via-cyan-500/10 to-trust-500/10 blur-3xl" />

        <div className="relative bg-gradient-to-br from-trust-500/10 to-cyan-500/10 border border-trust-500/30 p-8 md:p-12 lg:p-16">
          <div className="flex flex-col lg:flex-row items-center gap-8 lg:gap-12">
            {/* Left content */}
            <div className="flex-1 text-center lg:text-left">
              {/* サポートバッジ */}
              <div className="mb-6 flex justify-center lg:justify-start">
                <SupportBadge variant="dark" />
              </div>
            ...
            <div className="flex-shrink-0 hidden lg:block">
              <div className="relative">
                ...
                <div className="relative w-64 h-80 rounded-2xl overflow-hidden border border-white/10">
                  <Image
                    src="/formal/D_05_graph011.png"
                    alt="右肩上がりの成果グラフ"
                    width={256}
                    height={320}
                    className="w-full h-full object-contain bg-dark-50 p-4"
                  />
                ...
                {/* フローティングメッセージ */}
                <div className="absolute -bottom-3 -left-3 bg-dark-50 rounded-xl shadow-lg p-3 max-w-[180px] border border-trust-500/30">
