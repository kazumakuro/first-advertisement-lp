...
import { cta } from "@/config/content-branding";
import { SupportBadge } from "@/components/shared/SupportSection";
import { trackCTAClick, trackExternalLink } from "@/lib/analytics";

export function CTABranding() {
  const handleCTAClick = () => {
    trackCTAClick("cta-branding", cta.primary);
    trackExternalLink("LINE", "cta-branding");
  };

  return (
    <section className="relative py-20 md:py-28 bg-gradient-to-b from-orange-50 to-rose-50" id="cta">
      <div className="container mx-auto px-4 md:px-6 lg:px-8">
        <div className="relative max-w-5xl mx-auto">
          {/* Background effect */}
          <div className="absolute inset-0 bg-gradient-to-r from-warmth-200/50 via-rose-200/50 to-violet-200/50 blur-3xl" />

          <div className="relative bg-white border border-warmth-100 p-8 md:p-12 lg:p-16 rounded-3xl shadow-xl shadow-warmth-200/50">
            <div className="flex flex-col lg:flex-row items-center gap-8 lg:gap-12">
              ...
              <div className="flex-1 text-center lg:text-left">
                ...
                <div className="flex flex-wrap justify-center lg:justify-start gap-4 md:gap-6 mb-10">
                  {cta.benefits.map((benefit, index) => (
                    ...
                    >
                      <svg
                        className="w-5 h-5 text-warmth-500"
                        fill="currentColor"
                        viewBox="0 0 20 20"
                      >
                        <path
              ...
              <div className="flex-shrink-0 hidden lg:block">
                <div className="relative">
                  ...
                  {/* フローティングメッセージ */}
                  <div className="absolute -bottom-4 -left-4 bg-white rounded-2xl shadow-lg p-4 max-w-[180px] border border-warmth-100">
