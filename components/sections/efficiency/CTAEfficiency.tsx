...
export function CTAEfficiency() {
  const handleCTAClick = () => {
    trackCTAClick("cta-efficiency", cta.primary);
    trackExternalLink("LINE", "cta-efficiency");
  };
  return (
    <Section background="dark" id="cta">
      <div className="relative max-w-5xl mx-auto">
        ...
        <div className="relative bg-gradient-to-br from-electric-500/10 to-neon-500/10 border border-electric-500/30 p-8 md:p-12 lg:p-16">
          <div className="flex flex-col lg:flex-row items-center gap-8 lg:gap-12">
            ...
            <div className="flex-shrink-0 hidden lg:block">
              <div className="relative">
                ...
                {/* フローティングメッセージ */}
                <div className="absolute -bottom-3 -left-3 bg-dark-50 rounded-xl shadow-lg p-3 max-w-[180px] border border-electric-500/30">
